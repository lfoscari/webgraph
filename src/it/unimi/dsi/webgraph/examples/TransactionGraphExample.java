...
public class TransactionGraphExample {
	public static void main(String[] args) throws IOException {
		...
		Object2IntFunction<? extends CharSequence> addressIntMap = (n) -> (int) addressMap.getLong(n), transactionMap = (s) -> Integer.parseInt(((String) s).substring(1));
		...
		System.out.println(new TransactionGraph(inputs, outputs, addressIntMap, Charset.defaultCharset(), 8, prototype, labelMapping, 10, null, null));
		System.out.println(new ScatteredLabelledArcsASCIIGraph(arcs, addressMap, Charset.defaultCharset(), 8, prototype, labelMapping, null, false, false, 10));
	}
}
