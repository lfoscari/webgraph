...
public class GammaCodedLongLabel extends AbstractLongLabel {
	 ...
	 */
	public GammaCodedLongLabel(final String key, final long value) {
		super(key, value);
	 ...
	 */
	public GammaCodedLongLabel(final String... key) {
		super(key[0], 0);
	}

	@Override
	public GammaCodedLongLabel copy() {
		return new GammaCodedLongLabel(key, value);
	}
	...
	public int fromBitStream(final InputBitStream inputBitStream, final int sourceUnused) throws IOException {
		...
		value = inputBitStream.readLongGamma();
	...
	public int toBitStream(final OutputBitStream outputBitStream, final int sourceUnused) throws IOException {
		return outputBitStream.writeLongGamma(value);
	}
