...
public class ScatteredLabelledArcsASCIIGraph extends ImmutableSequentialGraph {
	 ...
	 */
	public static final LabelMapping DEFAULT_LABEL_MAPPING = (prototype, representation) -> ((GammaCodedLongLabel) prototype).value = Long.parseLong(new String(representation));
	...
	static long getLong(final byte[] array, int offset, int length) {
